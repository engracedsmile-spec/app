...
import { Loader2, Calendar, User, Car, Hash, ChevronRight, Tag, CreditCard } from "lucide-react";
    ...
    <div className="h-full flex flex-col bg-card">
        <main className="flex-1 space-y-4 p-4 md:p-6 overflow-y-auto">
            ...
            <DetailCard
                ...
                value={data.paymentMethod || "Pay with Paystack"}
            />
        </main>
             ...
             <div className="text-center">
                ...
                {days > 1 && (
                    <p className="text-xs text-muted-foreground">
                        (Base: {new Intl.NumberFormat('en-NG', { style: 'currency', currency: 'NGN'}).format(basePrice)} + {days - 1} extra day(s) at {new Intl.NumberFormat('en-NG', { style: 'currency', currency: 'NGN'}).format(dailyRate)}/day)
                    </p>
                )}
            </div>
