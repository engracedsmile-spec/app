exports.id=6519,exports.ids=[6519],exports.modules={6764:(e,t,a)=>{Promise.resolve().then(a.bind(a,94923))},95379:(e,t,a)=>{"use strict";a.d(t,{m:()=>y});var r=a(10326),s=a(91664),i=a(63062),n=a(24230),o=a(90434),l=a(76030),c=a(17577),d=a(55153),u=a(42244),h=a(48193),g=a(29752),p=a(19819),m=a(35047);let f=e=>{let t=e,a="dashboard",r={dashboard:{slug:"overview",category:"dashboard"},shipments:{slug:"manage-trips",category:"bookings"},departures:{slug:"schedule-departures",category:"bookings"},users:{slug:"manage-users",category:"users"},drivers:{slug:"manage-drivers",category:"users"},payouts:{slug:"payouts",category:"financials"},report:{slug:"reports",category:"financials"},routes:{slug:"manage-routes",category:"settings"},terminals:{slug:"manage-terminals",category:"settings"},vehicles:{slug:"manage-vehicles",category:"settings"},charter:{slug:"charter-packages",category:"settings"},general:{slug:"general-settings",category:"settings"},operations:{slug:"general-settings",category:"settings"}};r[e]&&(t=r[e].slug,a=r[e].category);let s=l.u.find(e=>e.slug===a);return s?.articles.find(e=>e.slug===t)},y=({page:e="dashboard"})=>{let[t,a]=(0,c.useState)(!1),{showPreloader:l}=(0,p.l)(),y=(0,m.useRouter)(),v=(0,c.useMemo)(()=>f(e),[e]),b=(e,t)=>{e.preventDefault(),l(),y.push(t)};return v?(0,r.jsxs)(d.h,{open:t,onOpenChange:a,trigger:r.jsx(s.z,{variant:"ghost",size:"icon","aria-label":"Open help for this page",children:r.jsx(i.Z,{className:"h-6 w-6"})}),children:[r.jsx(u.OX,{className:"border-b px-4 py-3",children:r.jsx(u.iI,{className:"text-xl font-bold",children:v.title})}),(0,r.jsxs)(u.Ng,{children:[r.jsx("div",{className:"prose prose-sm dark:prose-invert max-w-none",children:r.jsx(h.UG,{children:v.content})}),v.relatedArticles&&v.relatedArticles.length>0&&(0,r.jsxs)("div",{className:"mt-8 pt-4 border-t",children:[r.jsx("h3",{className:"text-lg font-semibold mb-3",children:"Related Articles"}),r.jsx("div",{className:"space-y-2",children:v.relatedArticles.map(e=>r.jsx(o.default,{href:`/admin/dashboard/help/${e.category}/${e.slug}`,onClick:t=>{a(!1),b(t,`/admin/dashboard/help/${e.category}/${e.slug}`)},children:r.jsx(g.Zb,{className:"hover:bg-muted transition-colors",children:(0,r.jsxs)(g.aY,{className:"p-3 flex items-center justify-between",children:[r.jsx("span",{className:"font-medium text-sm",children:e.title}),r.jsx(n.Z,{className:"h-4 w-4 text-muted-foreground"})]})})},e.slug))})]})]})]}):r.jsx(o.default,{href:"/admin/dashboard/help",onClick:e=>b(e,"/admin/dashboard/help"),children:r.jsx(s.z,{variant:"ghost",size:"icon","aria-label":"Open help center",children:r.jsx(i.Z,{className:"h-6 w-6"})})})}},76030:(e,t,a)=>{"use strict";a.d(t,{u:()=>r});let r=[{slug:"dashboard",title:"Dashboard",articles:[{slug:"overview",title:"Dashboard Overview",description:"Understand the main dashboard views: Operations, Financials, and Analytics.",content:`The main dashboard provides a high-level overview of your business operations. It's divided into three main screens that you can cycle through using the controls at the top.
...
`}]}]},94923:(e,t,a)=>{"use strict";a.r(t),a.d(t,{default:()=>l});var r=a(10326),s=a(49260),i=a(35047);a(17577);var n=a(15971),o=a(87321);/**
 * @project Engraced Smiles
 * @author Daniel Innocent <@mdtbmw>
 * @copyright Copyright (c) 2024. All rights reserved.
 * This software is the exclusive property of Daniel Innocent.
 * A license has been granted to Mr. Ismail Muhammed for resale to Engraced Smiles.
 */function l({children:e}){let{user:t,loading:a}=(0,s.a)();return((0,i.useRouter)(),a||!t||"admin"!==t.userType)?r.jsx(n.Preloader,{}):(0,r.jsxs)("div",{className:"flex flex-col h-dvh",children:[r.jsx("main",{className:"flex-1 overflow-y-auto pb-24",children:e}),r.jsx(o.h,{})]})}},91664:(e,t,a)=>{"use strict";a.d(t,{d:()=>l,z:()=>c});var r=a(10326),s=a(17577),i=a(99469),n=a(79360),o=a(51223);let l=(0,n.j)("inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",{variants:{variant:{default:"bg-primary text-primary-foreground hover:bg-primary/90",destructive:"bg-destructive text-destructive-foreground hover:bg-destructive/90",outline:"border border-input bg-background hover:bg-accent hover:text-accent-foreground",secondary:"bg-secondary text-secondary-foreground hover:bg-secondary/80",ghost:"hover:bg-accent hover:text-accent-foreground",link:"text-primary underline-offset-4 hover:underline"},size:{default:"h-10 px-4 py-2",sm:"h-9 rounded-md px-3",lg:"h-11 rounded-md px-8",icon:"h-10 w-10"}},defaultVariants:{variant:"default",size:"default"}}),c=s.forwardRef(({className:e,variant:t,size:a,asChild:s=!1,...n},c)=>{let d=s?i.g7:"button";return r.jsx(d,{className:(0,o.cn)(l({variant:t,size:a,className:e})),ref:c,...n})});c.displayName="Button"},86120:(e,t,a)=>{"use strict";a.r(t),a.d(t,{$$typeof:()=>n,__esModule:()=>i,default:()=>o});var r=a(68570);let s=(0,r.createProxy)(String.raw`/root/app/src/app/admin/dashboard/layout.tsx`),{__esModule:i,$$typeof:n}=s;s.default;let o=(0,r.createProxy)(String.raw`/root/app/src/app/admin/dashboard/layout.tsx#default`)}};